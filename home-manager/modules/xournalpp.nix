
{
  xdg.configFile."xournalpp/settings.xml".text = ''
    ...
    <settings>
      ...
      <property name="mainWndWidth" value="640"/>
      <property name="mainWndHeight" value="1053"/>
      <property name="maximized" value="true"/>
      <property name="showToolbar" value="true"/>
      <property name="showSidebar" value="true"/>
      <property name="sidebarWidth" value="144"/>
      ...
      <property name="selectionBorderColor" value="4280557361"/>
      <property name="backgroundColor" value="4282202182"/>
      <property name="selectionMarkerColor" value="4294365997"/>
      ...
      <data name="buttonConfig">
        ...
        <data name="stylus">
          <attribute name="tool" type="string" value="selectMultiLayerRegion"/>
        </data>
        <data name="stylus2">
          <attribute name="tool" type="string" value="none"/>
        </data>
      ...
      <data name="deviceClasses">
        <data name="SYNA2BA6:00 06CB:CD3E Mouse">
          <attribute name="deviceClass" type="int" value="1"/>
          <attribute name="deviceSource" type="int" value="0"/>
        </data>
        <data name="SYNA2BA6:00 06CB:CD3E Touchpad">
          <attribute name="deviceClass" type="int" value="1"/>
          <attribute name="deviceSource" type="int" value="6"/>
        </data>
        <data name="Wacom HID 52B0 Finger">
          <attribute name="deviceClass" type="int" value="4"/>
          <attribute name="deviceSource" type="int" value="5"/>
        </data>
        <data name="Wacom HID 52B0 Pen Eraser (0x8020f480)">
          <attribute name="deviceClass" type="int" value="3"/>
          <attribute name="deviceSource" type="int" value="2"/>
        </data>
        <data name="Wacom HID 52B0 Pen Eraser (0x8020f49f)">
          <attribute name="deviceClass" type="int" value="3"/>
          <attribute name="deviceSource" type="int" value="2"/>
        </data>
        <data name="Wacom HID 52B0 Pen Eraser (0x80fcf480)">
          <attribute name="deviceClass" type="int" value="3"/>
          <attribute name="deviceSource" type="int" value="2"/>
        </data>
        <data name="Wacom HID 52B0 Pen Pen (0x8020f480)">
          <attribute name="deviceClass" type="int" value="2"/>
          <attribute name="deviceSource" type="int" value="1"/>
        </data>
        <data name="Wacom HID 52B0 Pen Pen (0x8020f484)">
          <attribute name="deviceClass" type="int" value="2"/>
          <attribute name="deviceSource" type="int" value="1"/>
        </data>
        <data name="Wacom HID 52B0 Pen Pen (0x8020f49f)">
          <attribute name="deviceClass" type="int" value="2"/>
          <attribute name="deviceSource" type="int" value="1"/>
        </data>
        <data name="Wacom HID 52B0 Pen Pen (0x8020fea0)">
          <attribute name="deviceClass" type="int" value="2"/>
          <attribute name="deviceSource" type="int" value="1"/>
        </data>
        <data name="Wacom HID 52B0 Pen Pen (0x8020ffe0)">
          <attribute name="deviceClass" type="int" value="2"/>
          <attribute name="deviceSource" type="int" value="1"/>
        </data>
        <data name="Wacom HID 52B0 Pen Pen (0x80fcf480)">
          <attribute name="deviceClass" type="int" value="2"/>
          <attribute name="deviceSource" type="int" value="1"/>
        </data>
        <data name="Wacom HID 52B0 Pen Pen (0x9120f480)">
          <attribute name="deviceClass" type="int" value="2"/>
          <attribute name="deviceSource" type="int" value="1"/>
        </data>
        <data name="Wacom HID 52B0 Pen Pen (0xbf20f480)">
          <attribute name="deviceClass" type="int" value="2"/>
          <attribute name="deviceSource" type="int" value="1"/>
        </data>
        <data name="Wacom HID 52B0 Pen Pen (0xbf20f49f)">
          <attribute name="deviceClass" type="int" value="2"/>
          <attribute name="deviceSource" type="int" value="1"/>
        </data>
      </data>
      <data name="lastUsedPageBgColor">
        <attribute name="color00" type="hex" value="ff000000"/>
        <attribute name="color01" type="hex" value="ffffffff"/>
        <attribute name="color02" type="hex" value="ffffffff"/>
        <attribute name="color03" type="hex" value="ffffffff"/>
        <attribute name="color04" type="hex" value="ffffffff"/>
        <attribute name="color05" type="hex" value="ffffffff"/>
        <attribute name="color06" type="hex" value="ffffffff"/>
        <attribute name="color07" type="hex" value="ffffffff"/>
        <attribute name="color08" type="hex" value="ffffffff"/>
        <attribute name="count" type="int" value="9"/>
      </data>
      <data name="tools">
